	...
	class Giacenze extends Database {
        ...
        public function creaGiacenzeCorrenti() {
            ...
            $sql =" insert into giacenze_correnti
                    ...
                    from $this->tableName as g where g.anno = 2022 and g.data < CURRENT_DATE() and g.negozio not in ('SMBB','SMMD') group by 1,2) as d on g.codice=d.codice and g.negozio=d.negozio and g.data=d.data
