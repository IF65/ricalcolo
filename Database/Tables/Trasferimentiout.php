<?php
	...
	class Trasferimentiout extends Database {
        
        public $tableNameT = 'trasferimenti_out';
        public $tableNameR = 'righe_trasferimenti_out';
        ...
        public function movimenti($record) {
             try {
                $data = $record['data'];
                $sql = "select t.`data`,r.`codice`,upper(t.`negozio_partenza`) `negozio`,sum(r.`quantita`) `quantita`
